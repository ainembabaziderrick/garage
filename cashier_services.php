                                                ...
                                                <form action="" method="post">
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="recipient-name" name="cost_price" placeholder="Enter Cost Price" required value="<?php echo $cost_price; ?>">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="recipient-name" class="col-form-label">Service Price</label>
                                                            <input type="text" class="form-control" id="recipient-name" name="price" placeholder="Enter Service Price" required value="<?php echo $price; ?>">
                                                        </div>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <form action="" method="post">
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="recipient-name" class="col-form-label">Cost Price</label>
                                                            <input type="text" class="form-control" id="recipient_cost_price" name="cost_price" placeholder="Enter Cost Price" required value="<?php echo $cost_price; ?>">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="recipient-name" class="col-form-label">Service Price</label>
                                                            <input type="text" class="form-control" id="recipient_price" name="price" placeholder="Enter Service Price" required value="<?php echo $price; ?>">
                                                        </div>
